    ...
    return (
        <div>
            ...
            <div className="relative h-48 sm:h-56 overflow-hidden">
                <img src="/images/prayers-hero.png" alt="Praise & Prayers" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0B3C5D]/80 to-[#0B3C5D]/30 flex items-end">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 w-full flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl sm:text-4xl font-extrabold text-white">Praise & Prayers</h1>
                            <p className="text-white/70 text-sm mt-1">Share your prayer requests and praise reports</p>
                        </div>
