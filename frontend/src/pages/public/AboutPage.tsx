...
const AboutPage: React.FC = () => (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">About Good News</h1>
        <div className="bg-white dark:bg-card-dark rounded-xl border border-cream-300 dark:border-dpurple-900/40 p-8">
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                <strong className="text-gray-800 dark:text-white">Good News</strong> is a Malayalam Christian Newspaper Portal dedicated to spreading the Gospel and keeping the community informed. Our mission is <em>"Growth, Unity & Edification"</em>.
            </p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mt-8 mb-3">Our Values</h2>
